...
namespace MagicLeap
{
    ...
    public class ImageTrackingVisualizer : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Game Object switching the scene")]
        private GameObject _loadScene = null;
        ...
        void Awake()
        {
            ...
            if (null == _loadScene)
            {
                Debug.LogError("Error: ImageTrackingVisualizer._scene is not set, disabling script.");
                enabled = false;
                return;
            }
        ...
        private void RefreshViewMode()
        {
            switch (_lastViewMode)
            {
                case ImageTrackingExample.ViewMode.All:
                    ...
                    _loadScene.SetActive(_targetFound);
                    break;
