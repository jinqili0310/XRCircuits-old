...
namespace MagicLeap
{
    ...
    public class MobileAppExample : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                Debug.LogError("Error: MobileAppExample._moveButtonHighlight is not set, disabling script.");
                enabled = false;
                return;
            }
            if (_rightButtonHighlight == null)
            {
                Debug.LogError("Error: MobileAppExample._appButtonHighlight is not set, disabling script.");
                enabled = false;
                return;
            }
            if (_homeTapIndicator == null)
            {
                Debug.LogError("Error: MobileAppExample._homeTapIndicator is not set, disabling script.");
                enabled = false;
                return;
            }
            if (_touch1Indicator == null)
            {
                Debug.LogError("Error: MobileAppExample._touch1Indicator is not set, disabling script.");
                enabled = false;
                return;
            }
            if (_touch2Indicator == null)
            {
                Debug.LogError("Error: MobileAppExample._touch2Indicator is not set, disabling script.");
                enabled = false;
                return;
            }
            if (_keyboardText == null)
            {
                Debug.LogError("Error: MobileAppExample._keyboardText is not set, disabling script.");
                enabled = false;
                return;
            }
            if (_modelRenderer == null)
            {
                Debug.LogError("Error: MobileAppExample._modelRenderer is not set, disabling script.");
                enabled = false;
                return;
            }
