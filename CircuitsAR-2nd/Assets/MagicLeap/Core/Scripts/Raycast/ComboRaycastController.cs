...
{
    /// <summary>
    /// World and Virtual raycast combination from Controller
    /// </summary>
    [AddComponentMenu("Magic Leap/Raycast/Combo Raycast Controller")]
    public class ComboRaycastController : WorldRaycastController
    {
