...
public class ControllerActions : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MLInput.OnControllerConnected += ControllerConnected;
        MLInput.OnControllerDisconnected += ControllerDisconnected;
    }
    ...
    private void ControllerConnected(byte controllerId)
    {
        MLInputController controller = _controllerConnectionHandler.ConnectedController;
        if (controller != null && controller.Id == controllerId)
        {
            Debug.Log($"Controller with id# {controller.Id} was connected");
        }
    }

    private void ControllerDisconnected(byte controllerId)
    {
        MLInputController controller = _controllerConnectionHandler.ConnectedController;
        if (controller != null && controller.Id == controllerId)
        {
            Debug.Log($"Controller with id# {controller.Id} was disconnected");
        }
    }
